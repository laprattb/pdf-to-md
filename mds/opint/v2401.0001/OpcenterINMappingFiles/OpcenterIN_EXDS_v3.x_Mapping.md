...
|UADM|vDefectType_Siemens_1029800126<br>,vDefectGroup_Siemen_1773021159|'DefectType_'+ Id ,GroupPath_' +Id||DefectClassKey|DefectClassKey|DefectClassKey|DefectClassKey|
|UADM|vDefectType_Siemens_1029800126<br>,vDefectGroup_Siemen_1773021159|Name or Nid||Name|Name|Name|Name|
|UADM|vDefectType_Siemens_1029800126<br>,vDefectGroup_Siemen_1773021159|Description,Description||Description|Description|Description|Description|
...
|UADM|vDefect_Siemens_Sim_2091630976|Id + '_' + DefectType,Id+ '_' +GroupPath||DefectDefectClassKey|DefectDefectClassKey|DefectDefectClassKey|DefectDefectClassKey|
...
|UADM|vDefect_Siemens_Sim_2091630976,vDefectGroup_Siemen<br>_1773021159|DefectType_' + DefectType,'GroupPath_' + Id|DefectType_' + DefectType,'GroupPath_' + Id|DefectType_' + DefectType,'GroupPath_' + Id|DefectType_' + DefectType,'GroupPath_' + Id|DefectType_' + DefectType,'GroupPath_' + Id|DefectType_' + DefectType,'GroupPath_' + Id|
...
|Col1|Col2|Col3|LaborTimeCategory|Col5|WorkOrderHistoryAction|UI Work Orders >> select a WorkOrder >> button As Built >> tab<br>Activity History<br>You can also see them on UI Genealogy, in the tree representation,<br>under each WorkOrderOperation node|Col8|
|---|---|---|---|---|---|---|---|
...
||||~~**Location**~~||~~**Location property of MaterialItem**~~|This property is not shown on UI because as OOTB we identify the<br>location of the MaterialItem by the Buffer when it has been added to<br>(UI Material Items >> Material Item Details)||
|----|----|<site_id>||LocationSiteId||||
|UADM|vLocation_Siemens_Si_307154647|Id||LocationKey|LocationKey|LocationKey|LocationKey|
|UADM|vLocation_Siemens_Si_307154647|Name or  NId||Name|Name|Name|Name|
|UADM|vLocation_Siemens_Si_307154647|Description||Description|Description|Description|Description|
...
|UADM|vMaterialGroup_Siem_2035655829|Id||MaterialClassKey|MaterialClassKey|MaterialClassKey|MaterialClassKey|
|UADM|vMaterialGroup_Siem_2035655829|Name or NId||Name|Name|Name|Name|
|UADM|vMaterialGroup_Siem_2035655829|Description||Description|Description|Description|Description|
...
|UADM|vDM_Material_Siemens_463872986|Id||MaterialDefinitionMaterialClassKey|MaterialDefinitionMaterialClassKey|MaterialDefinitionMaterialClassKey|MaterialDefinitionMaterialClassKey|
|----|----|<site_id>||MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|
...
|UADM|vDM_Material_Siemens_463872986|MaterialClass_Id|MaterialClass_Id|MaterialClass_Id|MaterialClass_Id|MaterialClass_Id|MaterialClass_Id|
...
|UADM|vMaterial_Siemens_Si_170253665|(Id +'_' +'Revision' or Id +'_' +'IsCurrent') or<br>(Id +'_' +'SerialNumberProfile' or Id +'_'<br>+'FirstArticleInspection' or Id +'_'<br>+'WeightUom' or Id +'_' +'VolumeUom' or Id<br>+'_' +'WeightQuantity' or Id +'_'<br>+'VolumeQuantity' or<br>Id +'_' +'Code')||MaterialDefinitionPropertyStaticValueKey|MaterialDefinitionPropertyStaticValueKey|MaterialDefinitionPropertyStaticValueKey|MaterialDefinitionPropertyStaticValueKey|
|----|----|<site_id>||MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|
|UADM|vMaterial_Siemens_Si_170253665|Id|Id|Id|Id|Id|Id|
...
|UADM|vMaterial_Siemens_Si_170253665 or<br>vDM_Material_Siemens_463872986|(Revision or IsCurrent) or<br>(SerialNumberProfile or FirstArticleInspection<br>or UoMNId.Weight or UoMNId.Volume||StringValue|StringValue|StringValue|StringValue|
|UADM|vDM_Material_Siemens_463872986|QuantityValue.Weight or<br>QuantityValue.Volume||FloatValue|FloatValue|FloatValue|FloatValue|
...
|----|----|<site_id>|Col4|MaterialLotHierarchySiteId|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
...
|UADM|vNonConformance_Sieme_73759778|Quantity|Col4|NonConformantQuantity|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
||||~~**NonConformanceClass**~~||~~**NonConformanceSeverity**~~|UI Non-Conformances >> tab Details||
|----|----|<site_id>||NonConformanceClassSiteId||||
|UADM|vNonConformance_Sieme_73759778|("Severity_" + Severity) OR<br>("Type_"+ Type)||NonConformanceClassKey|NonConformanceClassKey|NonConformanceClassKey|NonConformanceClassKey|
...
|UADM|vNonConformance_Sieme_73759778|(Id + '_' + 'Severity_' + Severity ) OR (Id  + '_' +<br>('Type_' + [Type]))||NonConformanceNonConformanceClassKey|NonConformanceNonConformanceClassKey|NonConformanceNonConformanceClassKey|NonConformanceNonConformanceClassKey|
...
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|Id||OperationDefinitionKey|OperationDefinitionKey|OperationDefinitionKey|OperationDefinitionKey|
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|Name OR Nid||Name|Name|Name|Name|
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|Description||Description|Description|Description|Description|
...
|----|----|<site_id>|Col4|OperationDefinitionId|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
|UADM|vOperation_Siemens_S_700803909|Id|Id|Id|Id|Id|Id|
|----|----|<site_id>||MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|
|UADM|vMaterial_Siemens_Si_170253665|Id|Id|Id|Id|Id|Id|
...
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|(Id + '_Operation) or (Id + '_Step')||OperationDefinitionOperationDefinitionClassKey|OperationDefinitionOperationDefinitionClassKey|OperationDefinitionOperationDefinitionClassKey|OperationDefinitionOperationDefinitionClassKey|
|----|----|<site_id>||OperationDefinitionClassId|OperationDefinitionClassId|OperationDefinitionClassId|OperationDefinitionClassId|
|----|----|"Operation" or "Step"||||||
|----|----|<site_id>||OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|Id||||||
...
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|(Id+'_' +'EstimatedDuration') or (Id+'_'<br>+'Revision')||OperationDefinitionPropertyStaticValueKey|OperationDefinitionPropertyStaticValueKey|OperationDefinitionPropertyStaticValueKey|OperationDefinitionPropertyStaticValueKey|
|----|----|<site_id>||OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|Id|Id|Id|Id|Id|Id|
...
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|EstimatedDuration||FloatValue|FloatValue|FloatValue|FloatValue|
|UADM|vOperation_Siemens_S_700803909 or<br>vStep_Siemens_Simati_938557012|Revision||StringValue|StringValue|StringValue|StringValue|
...
|----|----|"Process" OR "AsPlanned" OR "ERPOrder" OR<br>"InitialQuantity" OR "IsUnderScheduling" OR<br>"ParentBatch" OR "PoC" OR "Priority" OR<br>"ProcessNId" OR "ProcessRevision" OR<br>"ProcessUId" OR "ReworkOfOrder"|Col4|OperationExecutionPropertyKey|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
|----|----|"Process" OR "AsPlanned" OR "ERPOrder" OR<br>"InitialQuantity" OR "IsUnderScheduling" OR<br>"ParentBatch" OR "PoC" OR "Priority" OR<br>"ProcessNId" OR "ProcessRevision" OR<br>"ProcessUId" OR "ReworkOfOrder"||Name|Name|Name|Name|
|----|----|"String" OR "Numeric"||PropertyTypeId|PropertyTypeId|PropertyTypeId|PropertyTypeId|
|----|----|"n/a"||UomId<br>|UomId<br>|UomId<br>|UomId<br>|
...
|UADM|vWorkOrder_Siemens_S_749389132|(NId + '_' + 'Process') OR (NId + '_' +<br>'AsPlanned') OR (NId + '_' + 'ERPOrder') OR<br>(NId + '_' + 'InitialQuantity') OR (NId + '_' +<br>'IsUnderScheduling') OR (NId + '_' +<br>'ParentBatch') OR (NId + '_' + 'PoC') OR (NId +<br>'_' + 'Priority') OR (NId + '_' + 'ProcessNId') OR<br>(NId + '_' + 'ProcessRevision') OR (NId + '_' +<br>'ProcessUId') OR (NId + '_' + 'ReworkOfOrder')||OperationExecutionPropertyStaticValueKey|OperationExecutionPropertyStaticValueKey|OperationExecutionPropertyStaticValueKey|OperationExecutionPropertyStaticValueKey|
|----|----|<site_id>||OperationExecutionId|OperationExecutionId|OperationExecutionId|OperationExecutionId|
|UADM|vWorkOrder_Siemens_S_749389132|NId|NId|NId|NId|NId|NId|
|UADM|vWorkOrder_Siemens_S_749389132|Process or  AsPlanned or ReworkOfOrder or<br>ERPOrder or ParentBatch or ProcessRevision or<br>ProcessNId or ProcessUId||StringValue|StringValue|StringValue|StringValue|
|UADM|vWorkOrder_Siemens_S_749389132|InitialQuantity, IsUnderScheduling, [Priority],<br>PoC||FloatValue|FloatValue|FloatValue|FloatValue|
...
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Id||OperationRequestKey|OperationRequestKey|OperationRequestKey|OperationRequestKey|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Name OR Nid||Name|Name|Name|Name|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762|Description||Description|Description|Description|Description|
|----|----|<site_id>||OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|
...
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|StatusNId.Status|StatusNId.Status|StatusNId.Status|StatusNId.Status|StatusNId.Status|StatusNId.Status|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|EstimatedStartTime||StartDateTime|StartDateTime|StartDateTime|StartDateTime|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|EstimatedEndTime||EndDateTime|EndDateTime|EndDateTime|EndDateTime|
...
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|EstimatedDuration||Duration|Duration|Duration|Duration|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Sequence||Sequence|Sequence|Sequence|Sequence|
...
|UADM|vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Id||OperationRequestHierarchyKey|OperationRequestHierarchyKey|OperationRequestHierarchyKey|OperationRequestHierarchyKey|
|----|----|<site_id>||OperationRequestId|OperationRequestId|OperationRequestId|OperationRequestId|
|UADM|vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Id|Id|Id|Id|Id|Id|


|----|----|<site_id>|Col4|ParentOperationRequestId|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
|UADM|vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|ExecutionGroup_Id or WorkOrderOperation_Id|ExecutionGroup_Id or WorkOrderOperation_Id|ExecutionGroup_Id or WorkOrderOperation_Id|ExecutionGroup_Id or WorkOrderOperation_Id|ExecutionGroup_Id or WorkOrderOperation_Id|ExecutionGroup_Id or WorkOrderOperation_Id|
...
|----|----|<site_id>||OperationRequestId|OperationRequestId|OperationRequestId|OperationRequestId|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Id|Id|Id|Id|Id|Id|
...
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Id||OperationResponseKey|OperationResponseKey|OperationResponseKey|OperationResponseKey|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Name OR Nid||Name|Name|Name|Name|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vWorkOrderStep_Siem_1809795233|Description||Description|Description|Description|Description|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Sequence||Sequence|Sequence|Sequence|Sequence|
|----|----|<site_id>||OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|OperationDefinitionId|
|UADM|vWorkOrderOperation_1431095118|Operation|Operation|Operation|Operation|Operation|Operation|
|----|----|<site_id>||OperationExecutionId|OperationExecutionId|OperationExecutionId|OperationExecutionId|
...
|----|----|<site_id>||OperationRequestId|OperationRequestId|OperationRequestId|OperationRequestId|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Id|Id|Id|Id|Id|Id|
|UADM|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|ProducedQuantity||ProducedQuantity|ProducedQuantity|ProducedQuantity|ProducedQuantity|
...
|UADM|vMaterial_Siemens_Si_170253665|UoMNId||UomId|UomId|UomId|UomId|
|UADM|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|ActualStartTime||StartDateTime|StartDateTime|StartDateTime|StartDateTime|
|UADM|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|ActualEndTime||EndDateTime|EndDateTime|EndDateTime|EndDateTime|
|UADM|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|ExecutionDuration||Duration|Duration|Duration|Duration|
||||~~**OperationResponseClass**~~||~~**WorkOperationType**~~|UI Work Operations||
|----|----|<site_id>||OperationResponseClassSiteId||||
|UADM|vWorkOperationType_Si_94474546|Id OR "WorkOrderOperation" OR<br>"ExecutionGroup" OR "ExecutionGroupPhase"<br>OR "WorkOrderStep"||OperationResponseClassKey|OperationResponseClassKey|OperationResponseClassKey|OperationResponseClassKey|
|UADM|vWorkOperationType_Si_94474546|NId OR "WorkOrderOperation" OR<br>"ExecutionGroup" OR "ExecutionGroupPhase"<br>OR "WorkOrderStep"||Name<br>|Name<br>|Name<br>|Name<br>|
...
|----|----|<site_id>|Col4|OperationResponseEquipmentSpecificationSiteId|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
...
|UADM|vExecutionGroupPhase_469816675 or<br>vExecutionGroupPhase_931440969 or<br>vWorkOrderStep_Siem_1809795233|Id||OperationResponseHierarchyKey|OperationResponseHierarchyKey|OperationResponseHierarchyKey|OperationResponseHierarchyKey|
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|vExecutionGroupPhase_469816675 or<br>vExecutionGroupPhase_931440969 or<br>vWorkOrderStep_Siem_1809795233|Id OR<br>WorkOrderOperation_Id OR<br>Id|Id OR<br>WorkOrderOperation_Id OR<br>Id|Id OR<br>WorkOrderOperation_Id OR<br>Id|Id OR<br>WorkOrderOperation_Id OR<br>Id|Id OR<br>WorkOrderOperation_Id OR<br>Id|Id OR<br>WorkOrderOperation_Id OR<br>Id|
|----|----|<site_id>||ParentOperationResponseId|ParentOperationResponseId|ParentOperationResponseId|ParentOperationResponseId|
|UADM|vExecutionGroupPhase_469816675 or<br>vExecutionGroupPhase_931440969 or<br>vWorkOrderStep_Siem_1809795233|ExecutionGroup_Id OR<br>ExecutionGroupPhase_Id OR<br>WorkOrderOperation_Id|ExecutionGroup_Id OR<br>ExecutionGroupPhase_Id OR<br>WorkOrderOperation_Id|ExecutionGroup_Id OR<br>ExecutionGroupPhase_Id OR<br>WorkOrderOperation_Id|ExecutionGroup_Id OR<br>ExecutionGroupPhase_Id OR<br>WorkOrderOperation_Id|ExecutionGroup_Id OR<br>ExecutionGroupPhase_Id OR<br>WorkOrderOperation_Id|ExecutionGroup_Id OR<br>ExecutionGroupPhase_Id OR<br>WorkOrderOperation_Id|
||||~~**OperationResponseLaborSpecification**~~|~~**OperationResponseLaborSpecification**~~||||
|----|----|<site_id>||OperationResponseLaborSpecificationSiteId||||
|UADM|vWorkOrderHistory_Si_518515069|(UserId + '_' + WorkOrderOperation_Id  + '_' +<br>Date) OR (UserId + '_' +<br>ExecutionGroupPhaseId + '_' + Date) OR<br>(UserId + '_' + WorkOrderStep_Id + '_' + Date)||OperationResponseLaborSpecificationKey|OperationResponseLaborSpecificationKey|OperationResponseLaborSpecificationKey|OperationResponseLaborSpecificationKey|
|----|----|<site_id>||LaborId|LaborId|LaborId|LaborId|
|UADM|vWorkOrderHistory_Si_518515069|UserId|UserId|UserId|UserId|UserId|UserId|
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|vWorkOrderHistory_Si_518515069|WorkOrderOperation_Id OR<br>ExecutionGroupPhaseId OR WorkOrderStep_Id|WorkOrderOperation_Id OR<br>ExecutionGroupPhaseId OR WorkOrderStep_Id|WorkOrderOperation_Id OR<br>ExecutionGroupPhaseId OR WorkOrderStep_Id|WorkOrderOperation_Id OR<br>ExecutionGroupPhaseId OR WorkOrderStep_Id|WorkOrderOperation_Id OR<br>ExecutionGroupPhaseId OR WorkOrderStep_Id|WorkOrderOperation_Id OR<br>ExecutionGroupPhaseId OR WorkOrderStep_Id|
...
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|vToBeConsumedMateri_2105885214|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|
|----|----|<site_id>||MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|MaterialDefinitionId|
|UADM|vMaterial_Siemens_Si_170253665|Id|Id|Id|Id|Id|Id|
...
|UADM|vActualConsumedMater_420487820|(Id + '_WorkOrderOperation') OR (Id +<br>'_WorkOrderStep')||OperationResponseMaterialLotSpecificationInKey|OperationResponseMaterialLotSpecificationInKey|OperationResponseMaterialLotSpecificationInKey|OperationResponseMaterialLotSpecificationInKey|
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|vActualConsumedMater_420487820|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|
|----|----|<site_id>||MaterialLotId|MaterialLotId|MaterialLotId|MaterialLotId|
|UADM|vMaterialTrackingUni_494706508|NId|NId|NId|NId|NId|NId|
|UADM|vActualConsumedMater_420487820|MaterialItemAssembledQty||Quantity<br>|Quantity<br>|Quantity<br>|Quantity<br>|
||||~~**OperationResponseMaterialLotSpecificationOut**~~|~~**OperationResponseMaterialLotSpecificationOut**~~|~~**ProducedMaterialItem**~~|UI Work Orders >> open a WorkOrder: BatchID property/tab Serial<br>Numbers<br>UI Genealogy||
|----|----|<site_id>||OperationResponseMaterialLotSpecificationOutSiteId||||
|UADM|vActualConsumedMater_420487820|(Id + '_WorkOrderOperation') OR (Id +<br>'_WorkOrderStep')||OperationResponseMaterialLotSpecificationOutKey|OperationResponseMaterialLotSpecificationOutKey|OperationResponseMaterialLotSpecificationOutKey|OperationResponseMaterialLotSpecificationOutKey|
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|vActualConsumedMater_420487820|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|
|----|----|<site_id>||MaterialLotId|MaterialLotId|MaterialLotId|MaterialLotId|
|UADM|vMaterialTrackingUni_494706508|NId|NId|NId|NId|NId|NId|
...
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|((Id  + '_WorkOperationType') OR (Id  +<br>'_WorkOrderOperation' )) OR<br>(Id + '_ExecutionGroup') OR<br>(Id  + '_ExecutionGroupPhase') OR<br>(Id + '_WorkOrderStep')||OperationResponseOperationResponseClassKey|OperationResponseOperationResponseClassKey|OperationResponseOperationResponseClassKey|OperationResponseOperationResponseClassKey|
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|Id|Id|Id|Id|Id|Id|
|----|----|<site_id>||OperationResponseClassId|OperationResponseClassId|OperationResponseClassId|OperationResponseClassId|


|UADM|vWorkOrderOperation_1431095118 or<br>vExecutionGroup_Siem_277554762 or<br>vExecutionGroupPhase_469816675 or<br>vWorkOrderStep_Siem_1809795233|((WorkOperationType) OR<br>("WorkOrderOperation")) OR<br>"ExecutionGroup" OR<br>"ExecutionGroupPhase" OR<br>"WorkOrderStep"|Col4|Col5|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
...
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|SitmesDb|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|Id|Id|Id|Id|Id|Id|
...
|UADM|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|RequiredCertificateNId,<br>RequiredInspectionRole||StringValue|StringValue|StringValue|StringValue|


|UADM|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|ElectronicSignatureComplete,<br>ElectronicSignaturePause,<br>ElectronicSignatureStart, IsReady, Optional,<br>PauseDuration,<br>PartialWorkedQuantity, Priority,<br>TargetQuantity, WaitingForInspection,<br>ActiveNonConformanceNr, AvailableQuantity,<br>Skippable|Col4|FloatValue|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
|UADM|vWorkOrderOperation_1431095118 or<br>vWorkOrderStep_Siem_1809795233|LastPauseTime||DatetimeValue|DatetimeValue|DatetimeValue|DatetimeValue|
...
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|----|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|WorkOrderOperation_Id OR<br>WorkOrderStep_Id|
...
|UADM|vWorkInstructionStep_626862590|ItemNId|Col4|Col5|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
...
|UADM|vWorkInstructionStepIt_1299831 or<br>vRuntimeCharacteris_1195087565 or<br>vVisualDetectedFailu_686437194|ItemNId OR<br> Id OR<br>FailureNId||QualityParameterKey|QualityParameterKey|QualityParameterKey|QualityParameterKey|
|UADM|vWorkInstructionStepIt_1299831 or<br>vRuntimeCharacteris_1195087565 or<br>vVisualDetectedFailu_686437194|Label OR<br>Label OR<br>FailureNId||Name|Name|Name|Name|
|UADM|vWorkInstructionStepIt_1299831 or<br>vRuntimeCharacteris_1195087565 or<br>vVisualDetectedFailu_686437194|Caption OR<br>Label OR<br>FailureNId||Description|Description|Description|Description|
...
|UADM|vWorkInstructionStepIt_1299831 or<br>vInspectionValue_Siem_97476695 or<br>vVisualDetectedFailu_686437194|Id||QualityParameterValueKey|QualityParameterValueKey|QualityParameterValueKey|QualityParameterValueKey|
|----|----|<site_id>||QualityResponseId|QualityResponseId|QualityResponseId|QualityResponseId|
|UADM|vWorkInstructionSect_440022636 or<br>vInspectionValue_Siem_97476695 or<br>vVisualDetectedFailu_686437194|WorkInstruction_Id OR<br>InspectionSample_Id OR<br>InspectionSample_Id|WorkInstruction_Id OR<br>InspectionSample_Id OR<br>InspectionSample_Id|WorkInstruction_Id OR<br>InspectionSample_Id OR<br>InspectionSample_Id|WorkInstruction_Id OR<br>InspectionSample_Id OR<br>InspectionSample_Id|WorkInstruction_Id OR<br>InspectionSample_Id OR<br>InspectionSample_Id|WorkInstruction_Id OR<br>InspectionSample_Id OR<br>InspectionSample_Id|
|----|----|<site_id>||QualityParameterId|QualityParameterId|QualityParameterId|QualityParameterId|
|UADM|vWorkInstructionStepIt_1299831 or<br>vInspectionValue_Siem_97476695 or<br>vVisualDetectedFailu_686437194|ItemNId OR<br>Id OR<br>FailureNId|ItemNId OR<br>Id OR<br>FailureNId|ItemNId OR<br>Id OR<br>FailureNId|ItemNId OR<br>Id OR<br>FailureNId|ItemNId OR<br>Id OR<br>FailureNId|ItemNId OR<br>Id OR<br>FailureNId|
...
|UADM|vWorkInstructionStepIt_1299831 or<br>vInspectionValue_Siem_97476695 or<br>vVisualDetectedFailu_686437194|LastValueUpdatedOn OR<br>Timestamp OR<br>Timestamp||StartDateTime|StartDateTime|StartDateTime|StartDateTime|
...
|UADM|vWorkInstruction_Si_1625357712 or<br>vInspectionSample_S_1984849077|Id||QualityResponseKey|QualityResponseKey|QualityResponseKey|QualityResponseKey|
...
|UADM|vWorkInstruction_Si_1625357712|WorkInstructionDefinitionNId + '_' +<br>WorkInstructionDef_1609828362|WorkInstructionDefinitionNId + '_' +<br>WorkInstructionDef_1609828362|WorkInstructionDefinitionNId + '_' +<br>WorkInstructionDef_1609828362|WorkInstructionDefinitionNId + '_' +<br>WorkInstructionDef_1609828362|WorkInstructionDefinitionNId + '_' +<br>WorkInstructionDef_1609828362|WorkInstructionDefinitionNId + '_' +<br>WorkInstructionDef_1609828362|
|----|----|<site_id>||OperationResponseId|OperationResponseId|OperationResponseId|OperationResponseId|
|UADM|vWorkInstructionToWo_350679847 or<br>vToBeUsedInspection__861818088|WorkOrderOperation_Id  OR<br>(WorkOrderOperation_Id or<br>workorderstep_id)|WorkOrderOperation_Id  OR<br>(WorkOrderOperation_Id or<br>workorderstep_id)|WorkOrderOperation_Id  OR<br>(WorkOrderOperation_Id or<br>workorderstep_id)|WorkOrderOperation_Id  OR<br>(WorkOrderOperation_Id or<br>workorderstep_id)|WorkOrderOperation_Id  OR<br>(WorkOrderOperation_Id or<br>workorderstep_id)|WorkOrderOperation_Id  OR<br>(WorkOrderOperation_Id or<br>workorderstep_id)|
...
|----|----|<site_id>|Col4|QualityResponseQualityResponseClassSiteId|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
|UADM|vWorkInstruction_Si_1625357712 or<br>vInspectionSample_S_1984849077|Id + '_WorkInstruction' OR<br>Id  + '_InspectionSample'||QualityResponseQualityResponseClassKey|QualityResponseQualityResponseClassKey|QualityResponseQualityResponseClassKey|QualityResponseQualityResponseClassKey|
|----|----|<site_id>||QualityResponseId|QualityResponseId|QualityResponseId|QualityResponseId|
|UADM|vWorkInstruction_Si_1625357712 or<br>vInspectionSample_S_1984849077|Id|Id|Id|Id|Id|Id|
...
|UADM|vToolDefinition_Sie_1485280720|(Id  +'_' + 'ExpirationDate') OR (Id  +'_' +<br>'UsageCounterMax') OR (Id  +'_' +<br>'UsageDurationMax')  OR (Id  +'_' + 'Version')<br>OR (Id  +'_' + 'Consumable')||ToolDefinitionPropertyStaticValueKey|ToolDefinitionPropertyStaticValueKey|ToolDefinitionPropertyStaticValueKey|ToolDefinitionPropertyStaticValueKey|
|----|----|<site_id>||ToolDefinitionId|ToolDefinitionId|ToolDefinitionId|ToolDefinitionId|
|UADM|vToolDefinition_Sie_1485280720|Id|Id|Id|Id|Id|Id|
|----|----|<site_id>||ToolPropertyId|ToolPropertyId|ToolPropertyId|ToolPropertyId|
|----|----|"ExpirationDate" OR "UsageCounterMax" OR<br>"UsageDurationMax"  OR "Version"  OR<br>"Consumable"|"ExpirationDate" OR "UsageCounterMax" OR<br>"UsageDurationMax"  OR "Version"  OR<br>"Consumable"|"ExpirationDate" OR "UsageCounterMax" OR<br>"UsageDurationMax"  OR "Version"  OR<br>"Consumable"|"ExpirationDate" OR "UsageCounterMax" OR<br>"UsageDurationMax"  OR "Version"  OR<br>"Consumable"|"ExpirationDate" OR "UsageCounterMax" OR<br>"UsageDurationMax"  OR "Version"  OR<br>"Consumable"|"ExpirationDate" OR "UsageCounterMax" OR<br>"UsageDurationMax"  OR "Version"  OR<br>"Consumable"|
...
|UADM|vToolDefinition_Sie_1485280720|ExpirationDate|Col4|DatetimeValue|Col6|Col7|Col8|
|---|---|---|---|---|---|---|---|
...
|UADM|vTool_Siemens_Simat_1812587140|(Id  +'_' + 'ExpirationDate') OR (Id  +'_' +<br>'UsageCounter')  OR (Id  +'_' +<br>'UsageCounterMax') OR (Id  +'_' +<br>'UsageDuration') OR (Id  +'_' +<br>'UsageDurationMax')||ToolPropertyStaticValueKey|ToolPropertyStaticValueKey|ToolPropertyStaticValueKey|ToolPropertyStaticValueKey|
|----|----|<site_id>||ToolId|ToolId|ToolId|ToolId|
